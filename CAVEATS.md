...
- **Extrusion** (DXF 210) is carried on CIRCLE, ARC, ELLIPSE, LWPOLYLINE and 2D POLYLINE, as the file writes it; an absent group is the world Z axis. The elevation of an LWPOLYLINE (38) and of a 2D POLYLINE (its record's 30) is carried too. A CIRCLE's and an ARC's center and a polyline's vertices stay in their own coordinate system, as the file writes them -- taking them to the world is a consumer's arithmetic.
